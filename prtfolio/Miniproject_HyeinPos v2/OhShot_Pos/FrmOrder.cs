...
namespace OhShot_Pos
{
    public partial class FrmOrder : Form
    {
        ...
        private void backBtn_Click(object sender, EventArgs e) // 돌아가기 버튼
        {
           RollbackTransaction();
            this.Dispose();
        }
        ...
        private void OrderBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                RollbackTransaction();
                MessageBox.Show($"주문 처리 오류: {ex.Message}");
            }
        ...
        private void Alldelete(SqlConnection conn)
        {
            try
            {
                TransactionStart();
            ...
            {
                RollbackTransaction(); // 오류 발생 시 롤백
                MessageBox.Show($"데이터 삭제 오류: {ex.Message}");
            }
        }
